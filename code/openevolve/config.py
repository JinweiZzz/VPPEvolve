...
class PromptConfig:
    ...
    # Inspiration comparison feature
    enable_inspiration_comparison: bool = False  # Enable comparison summary for inspiration programs
    # Start generating inspiration comparison from round N (need enough programs and term_attribution)
    inspiration_comparison_min_round: int = 5
    ...
    enable_inspiration_borrowable_from_reflection: bool = False
